		...
		extend: {
			...
			keyframes: {
				...
				'glow': {
					...
					'50%': { boxShadow: '0 0 5px #3b82f680, 0 0 10px #3b82f680, 0 0 15px #3b82f680, 0 0 20px #3b82f680' }
				},
				'shimmer': {
			...
			backgroundImage: {
				...
				'risk-gradient': 'linear-gradient(180deg, hsl(var(--risk-low)) 0%, hsl(var(--risk-moderate)) 50%, hsl(var(--risk-high)) 100%)',
